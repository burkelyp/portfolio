...
async function show_project(port, project) {
    ...
    const ldblm_description = `<strong>Little Dreamer Big Leader Mobiles eCommerce Website: 
    ...
    Page' to protect the database. To open the site in a new page <a href='${source}:${port}' 
    target='_blank' rel='noopener noreferrer'">click here</a>`;
    
    const byte_hikers_description = `<strong>Byte Hikers Application: </strong>This project was built 
    ...
    dynamically using AJAX. To open the application in a new page <a href='${source}:${port}' 
    target='_blank' rel='noopener noreferrer'">click here</a>`;
    
    const ocean_description = `<strong>Oceanographic Research Project: </strong>This undergraduate 
    ...
    and modeling was completed using MatLab`;
